# AGENTS.md — Guía para instancias de Codex que trabajen en este repositorio

Este archivo es el punto de entrada para cualquier instancia de Codex (u otro
...
| Diseño visual | Canvas de **Codex Design** aprobado por el cliente antes de codificar componentes. Iconografía propia (`@glexco/icons`) + Lucide para el cromo de interfaz. |
...
| Commits | **Nunca** incluir `Co-Authored-By` ni atribución a Codex. Es una instrucción explícita del cliente y anula cualquier valor por defecto. |
